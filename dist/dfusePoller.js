"use strict"
let __createBinding = (this && this.__createBinding) || (Object.create
  ? function(o, m, k, k2) {
...
let __setModuleDefault = (this && this.__setModuleDefault) || (Object.create
  ? function(o, v) {
    ...
    dfuse[currentClient].graphql(dfuseQuery, async(message, stream) => {
      ...
      .catch(async(error) => {
        ...
        if ((error === null || error === void 0 ? void 0 : error.message) == "blocked: document quota exceeded") {
          ...
          if (currentClient == "client1") { currentClient = "client2" } else if (currentClient == "client2") { currentClient = "client3" } else if (currentClient == "client3") { currentClient = "client4" } else { currentClient = "client1" }
