...
var Api = /** @class */ (function () {
    ...
    Api.prototype.serializeTransaction = function (transaction) {
        ...
        this.serialize(buffer, 'transaction', __assign({ max_net_usage_words: 0, max_cpu_usage_ms: 3, delay_sec: 0, context_free_actions: [], actions: [], transaction_extensions: [] }, transaction));
